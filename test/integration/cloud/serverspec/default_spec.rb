...
describe 'Syslog Service' do
  describe file('/etc/rsyslog.d/45-haproxy.conf') do
    ...
    its(:content) { should match(%r{then /mnt/dev0/var/log/haproxy/haproxy.log\s+# Log no further\.\.\.\s+stop}) }
  end
  ...
  describe file('/mnt/dev0/var/log/haproxy/haproxy.log') do
